...
| 版本 | 說明 |
|------|------|
| `v2026.0221` | 移除密碼系統、全面升級簡約扁平化設計 (Minimal Flat UI)、引入清爽進度條與視窗貼齊 (Sticky Sidebar)、新增「No.」獨立序號欄位並修正名稱覆寫與排序問題、支援手動拖曳變更工作表排序、過濾移除 0 花費帳號、支援 PWA App 手機版（含底部導覽切換模式）、優化行動裝置橫向捲動體驗 |
